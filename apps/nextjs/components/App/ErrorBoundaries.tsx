...
const ErrorBoundary: React.FC<ErrorBoundaryProps> = ({ children }) => {
    useEffect(() => {
        const handleRuntimeError = (event: Event | string, source?: string, lineno?: number, colno?: number, errorObj?: Error) => {
        ...
        const handleRejection = (event: PromiseRejectionEvent) => {
            ...
            if (error.name === 'TransactionNotFoundError' || error.name === 'BlockNotFoundError') {
